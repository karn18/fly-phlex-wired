class ToastComponent < Phlex::Component
  def template
    div class: "flex space-x-2 justify-end absolute inset-x-0 top-0 md:right-0 px-2 md:px-4 lg:px-6 pt-12 justify-center md:justify-end lg:justify-end", "data-controller": "toast", "data-toast-delay-value": "2000" do
      div class: "border border-indigo-600 bg-white shadow-lg w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block",
        ...
        div class: "bg-white flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-gray-200 rounded-t-lg" do
          ...
          div class: "flex items-center" do
            p "now", class: "text-gray-600 text-xs"
          end
        end
        div class: "p-3 bg-white rounded-b-lg break-words text-gray-700", data_controller: "good-day"
      end
    end
  end
end
